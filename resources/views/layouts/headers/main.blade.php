	...
	<div class="navbar navbar-inverse navbar-fixed-top" role="banner"> 
		<div class="container"> 
			<div class="navbar-header"> 
				...
				<h1>
					<!-- <img src="/himu/images/logo.png" alt="logo"> -->
				</h1>
				</a> 
			</div> 
			<div class="collapse navbar-collapse"> 				
				<ul class="nav navbar-nav navbar-right">					
					...
					<li class="dropdown @if(Request::is('achivements*')) active @endif">
						...
						<ul class="dropdown-menu">
						    <li><a tabindex="-1" href="/achivements/university">Բուհ ընդունելություններ</a></li>
						    <li class="divider"></li>
						    <li><a tabindex="-1" href="/achivements/olimp">Օլիմպիադաներ</a></li>
						    <li class="divider"></li>
						    <li><a tabindex="-1" href="/achivements/competition">Մրցույթներ</a></li>
						    <li class="divider"></li>						   
						</ul>
					</li>
					<li class="dropdown @if(Request::is('/life*')) active @endif">
						...
						<ul class="dropdown-menu">						    
						    ...
						    <li class="divider"></li>
						    <li><a tabindex="-1" href="/tours">Շրջայց</a></li>
						    <li class="divider"></li>
						    <li><a tabindex="-1" href="/open-lessons">Բաց դասեր</a></li>
						    <li class="divider"></li>						   
						</ul>
					</li>
					<li class="dropdown @if(Request::is('/life*')) active @endif">
