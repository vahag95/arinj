...
@section('content')	
			...
			<div class="row text-center clearfix">
				<div class="col-sm-8 col-sm-offset-2">
					<div class="contact-heading">
						<h2 class="title-one">Շրջայցեր</h2>						
					</div>
				</div>
			</div>
		</div>
	...
	<section style="padding-top: 0" id="blog"> 
		<div class="container">			 
			<div class="row photos">				
				@foreach($image_urls as $image)
					<div style="" class="photo">
						<img style="border:2px solid #fc7700; cursor: zoom-in;" onclick="imageOpen('https://s3-us-west-2.amazonaws.com/arinj{{ $image }}', {{ json_encode($image_urls) }})" src="https://s3-us-west-2.amazonaws.com/arinj{{ $image }}">
					</div>
				@endforeach
			</div> 
		</div> 
